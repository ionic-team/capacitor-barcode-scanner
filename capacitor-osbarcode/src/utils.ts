...
export const barcodeScannerCss = [
  ...
  {selector: `.scanner-dialog`, css: `display: none; position: fixed; z-index: 999; left: 0; top: 0; width: 100%; height: 100%; overflow: auto; background-color: rgba(0,0,0,0.4);`},
  {selector: `.scanner-dialog-inner`, css: `background-color: #fefefe; margin: 2% auto; padding: 20px; border: 1px solid #888; width: 96%;`},
